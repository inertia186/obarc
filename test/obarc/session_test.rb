...
module OBarc
  class SessionTest < OBarc::Test
    ...
    def test_add_social_account
      response = @session.add_social_account social_account = {
    ...
    #   response = @session.delete_social_account social_account = {
    #     account_type: 'TWITTER',
    #   }
    #   assert response['success'], response
    # end
    ...
    #   response = @session.add_contract contract = {
    ...
    #   refute response, 'did not expect response after shutdown'
    # end
    ...
    #   response = @session.purchase_contract purchase_contract = {
    ...
    #   response = @session.complete_order complete_order = {
    #     id: 'id',
    #     feedback: 'feedback',
    #     qulity: 'quality',
    #     description: 'description',
    ...
    #   response = @session.settings = settings = {
    #     refund_address: "mmqcyagCJgCKwSDZmRxLS8N9yUW4unM3Qs",
